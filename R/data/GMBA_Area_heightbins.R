...
# Hier wird ein df mit den spalten altitude_bin areas und GMBA_V2_ID erstellt 
...
# Hier wird als Name in der Liste das GMBA_V2_ID angegeben
...
for(i in 1:nrow(GMBA)) {
  ...
  # Store the result in the list
  areas[[as.character(current_GMBA_V2_ID)]] <- as_tibble(npixel_per_bin, rownames = "altitude_bin")
